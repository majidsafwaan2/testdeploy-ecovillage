...
`;function T(n,e,a){if(!n){console.error("Conservation Chatbot: Container element not found for chatbot UI. Please provide a valid HTMLElement.");return}if(!Array.isArray(e)||e.length===0){console.error("Conservation Chatbot: Invalid animals array provided. Please provide a non-empty array of animals.");return}if(typeof a!="function"){console.error("Conservation Chatbot: Invalid createChatbotInstance function provided. Please provide a function that creates chatbot instances.");return}if(!document.getElementById("conservation-chatbot-styles")){const o=document.createElement("style");o.id="conservation-chatbot-styles",o.textContent=D,document.head.appendChild(o)}let h=0,s=a(e[h]);const m=document.createElement("div");m.id="conservation-chatbot-launcher";const d=document.createElement("img");d.src=s.getAnimalPhoto(),d.alt=`${s.getAnimalName()} Avatar`,m.appendChild(d),document.body.appendChild(m);const b=document.createElement("div");b.id="conservation-chatbot-container";const r=document.createElement("div");r.className="conservation-chatbot-header";const u=document.createElement("div");u.className="title-group";const v=document.createElement("img");v.src=s.getAnimalPhoto(),v.alt=`${s.getAnimalName()} Avatar`,v.className="conservation-chatbot-avatar",v.style.marginRight="3px";const y=document.createElement("select");y.className="conservation-chatbot-animal-select",y.style.marginLeft="3px",y.style.minWidth="unset",y.style.padding="4px 6px",e.forEach((o,l)=>{const p=document.createElement("option");p.value=l,p.textContent=`Talk to ${o.name}`,l===h&&(p.selected=!0),y.appendChild(p)});const t=document.createElement("button");t.className="conservation-chatbot-heart-button",t.innerHTML="♥",t.title="Show your love!",t.style.marginLeft="-20px",t.style.width="80px",t.style.fontSize="28px",t.style.background="none",t.style.border="none",t.style.color="white",t.style.cursor="pointer",t.style.transition="color 0.2s",t.style.height="36px",t.style.borderRadius="50%",t.style.display="flex",t.style.alignItems="center",t.style.justifyContent="center",t.style.lineHeight="1",t.style.padding="0";let c=!1;function w(){t.style.color=c?"#ff69b4":"white"}t.addEventListener("mouseenter",()=>{c||(t.style.color="#ff69b4")}),t.addEventListener("mouseleave",()=>{c||(t.style.color="white")}),t.addEventListener("mousedown",()=>{}),t.addEventListener("mouseup",()=>{}),t.addEventListener("click",()=>{c=!c,w()}),w();const S=document.createElement("button");S.className="conservation-chatbot-close-button",S.innerHTML="&times;",u.appendChild(v),u.appendChild(y),u.appendChild(t),r.appendChild(u),r.appendChild(S),b.appendChild(r);const g=document.createElement("div");g.className="conservation-chatbot-messages",b.appendChild(g);const C=document.createElement("div");C.className="conservation-chatbot-input-container";const L=document.createElement("div");L.className="conservation-chatbot-default-prompts";const R=[{text:"Fun Fact",prompt:"Tell me a fun fact!"},{text:"Threats",prompt:"What's your biggest threat?"},{text:"Help",prompt:"How can I help protect you?"}],E=[];R.forEach(o=>{const l=document.createElement("button");l.className="default-prompt-btn",l.textContent=o.text,l.dataset.prompt=o.prompt,L.appendChild(l),E.push(l)}),C.appendChild(L);const f=document.createElement("input");f.type="text",f.className="conservation-chatbot-input",f.placeholder="Ask me anything...",C.appendChild(f);const A=document.createElement("button");A.className="conservation-chatbot-send-button",A.textContent="Send",C.appendChild(A),b.appendChild(C),n.appendChild(b);const N=o=>{if(o>=0&&o<e.length){h=o,s=a(e[h]),d.src=s.getAnimalPhoto(),d.alt=`${s.getAnimalName()} Avatar`,v.src=s.getAnimalPhoto(),v.alt=`${s.getAnimalName()} Avatar`,g.innerHTML="";const p=e[h].intro||`Hello! I'm ${s.getAnimalName()}. What would you like to know about me and my conservation?`;I(p,"bot")}};let M=!1;const z=()=>{if(M=!M,M){if(b.style.display="flex",requestAnimationFrame(()=>{b.classList.add("expanded"),m.classList.add("hidden")}),g.children.length===0||g.children.length===1&&g.children[0].classList.contains("thinking")){const l=e[h].intro||`Hello! I'm ${s.getAnimalName()}. What would you like to know about me and my conservation?`;I(l,"bot")}f.focus()}else b.classList.remove("expanded"),m.classList.remove("hidden"),setTimeout(()=>{b.style.display="none"},300)};m.addEventListener("click",z),S.addEventListener("click",z),y.addEventListener("change",o=>{const l=parseInt(o.target.value);isNaN(l)||N(l)});function I(o,l){const p=document.createElement("div");return p.classList.add("conservation-chatbot-message",l),p.textContent=o,g.appendChild(p),g.scrollTop=g.scrollHeight,p}function B(){const o=document.createElement("div");return o.classList.add("conservation-chatbot-message","bot","thinking"),o.innerHTML=`
    ...
    .conservation-chatbot-send-button:hover {
        background-color: ${((R=e.colors)==null?void 0:R.secondary)||i.colors.secondary};
    }
    ...
    .conservation-chatbot-default-prompts .default-prompt-btn {
        ...
        font-size: ${((M=(N=e.fonts)==null?void 0:N.size)==null?void 0:M.small)||i.fonts.size.small};
    }
