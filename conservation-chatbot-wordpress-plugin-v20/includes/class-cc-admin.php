...
class CC_Admin {
    ...
    public function init() {
        ...
        add_action('updated_option', array($this, 'maybe_refresh_chatbot'), 10, 3);
        add_action('pre_update_option_cc_selected_animals', array($this, 'process_selected_animals'), 10, 2);
    }
    ...
    public function admin_page() {
        ...
        <div class="wrap">
            ...
            <form method="post" action="options.php">
                    ...
                    <table class="form-table">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="hidden" name="cc_selected_animals_processed" value="1" />
                            </td>
                        </tr>
                        <tr>
                ...
                <div id="appearance" class="tab-content" style="display: none;">
                    ...
                    <table class="form-table">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="cc_color_text" value="<?php echo esc_attr(get_option('cc_color_text', '#333333')); ?>" class="color-picker" />
                            </td>
                        </tr>
                        <tr>
                ...
                <input type="hidden" name="cc_custom_animals" value="<?php 
                    $custom_animals = get_option('cc_custom_animals', array());
                ...
                <input type="hidden" name="cc_theme" value="<?php echo esc_attr(get_option('cc_theme', 'nature')); ?>" />
    ...
    /**
     * Maybe refresh chatbot after settings update
     */
    public function maybe_refresh_chatbot($option_name, $old_value, $new_value) {
        // Only refresh if it's one of our settings
        if (strpos($option_name, 'cc_') === 0) {
            // Don't flush cache on every setting change - too memory intensive
            // Instead, just clear specific caches if needed
            if (function_exists('wp_cache_delete')) {
                wp_cache_delete('cc_settings', 'options');
            }
        }
    }
    
    /**
     * Process selected animals before saving
     */
    public function process_selected_animals($new_value, $old_value) {
        // Simple check for empty selection
        if (isset($_POST['cc_selected_animals_processed'])) {
            if (!isset($_POST['cc_selected_animals']) || empty($_POST['cc_selected_animals'])) {
                return array();
            }
            // Ensure we have a valid array
            if (is_array($_POST['cc_selected_animals'])) {
                return array_map('sanitize_text_field', $_POST['cc_selected_animals']);
            }
        }
        return $new_value;
    }
