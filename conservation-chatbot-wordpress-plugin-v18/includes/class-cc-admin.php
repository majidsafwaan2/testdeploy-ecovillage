...
class CC_Admin {
    ...
    public function admin_page() {
        ...
        <div class="wrap">
            ...
            <form method="post" action="options.php">
                ...
                <input type="hidden" name="cc_custom_animals" value="<?php echo esc_attr(json_encode(get_option('cc_custom_animals', array()))); ?>" />
    ...
    public function process_selected_animals($new_value, $old_value) {
        // If the processed field is set, ensure we handle empty arrays properly
        if (isset($_POST['cc_selected_animals_processed'])) {
            // If no animals are selected, return empty array
