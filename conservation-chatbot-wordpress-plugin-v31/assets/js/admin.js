...
jQuery(document).ready(function($) {
    ...
    $('#save-animal-selection').on('click', function() {
        console.log('Save animal selection button clicked');
        console.log('cc_ajax object:', cc_ajax);
        ...
        console.log('AJAX URL:', cc_ajax.ajax_url);
        console.log('Nonce:', cc_ajax.nonce);
    ...
    $('#test-ajax').on('click', function() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                alert('Test AJAX working! Response: ' + JSON.stringify(response));
            },
            error: function(xhr, status, error) {
