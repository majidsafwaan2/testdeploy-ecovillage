                ...
                <div id="appearance" class="tab-content" style="display: none;">
                    ...
                    <table class="form-table">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="cc_color_primary" value="<?php echo esc_attr(get_option('cc_color_primary', '#222222')); ?>" class="color-picker" />
                            </td>
                        </tr>
                        <tr>
                            <th scope="row">Secondary Color</th>
                            <td>
                                <input type="text" name="cc_color_secondary" value="<?php echo esc_attr(get_option('cc_color_secondary', '#444444')); ?>" class="color-picker" />
                            </td>
                        </tr>
                        <tr>
                            <th scope="row">Accent Color</th>
                            <td>
                                <input type="text" name="cc_color_accent" value="<?php echo esc_attr(get_option('cc_color_accent', '#222222')); ?>" class="color-picker" />
                            </td>
                        </tr>
                        <tr>
