                    ...
                    <table class="form-table">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <form method="post" action="<?php echo admin_url('admin.php?page=conservation-chatbot'); ?>" style="margin-bottom: 10px;">
                                    ...
                                    <button type="submit" class="button button-secondary" style="margin-top: 10px;">Save Animal Selection</button>
                                </form>
