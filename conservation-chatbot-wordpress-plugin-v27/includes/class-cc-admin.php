...
class CC_Admin {
    ...
    public function init() {
        ...
        // Add custom form handler for animal selection
        add_action('admin_post_cc_save_animal_selection', array($this, 'handle_animal_selection_save'));
    }
    ...
    /**
     * Custom form handler for animal selection
     */
    ...
    public function admin_page() {
        ...
        <div class="wrap">
            ...
            <!-- Separate form for animal selection -->
            <form method="post" action="<?php echo admin_url('admin-post.php'); ?>" style="margin-top: 20px; padding: 20px; background: #f9f9f9; border: 1px solid #ddd; border-radius: 4px;">
