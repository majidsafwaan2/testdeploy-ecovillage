...
class CC_Admin {
    ...
    public function sanitize_settings($input) {
        ...
        // If no animals are selected, ensure we have an empty array
        if (empty($sanitized['selected_animals'])) {
            $sanitized['selected_animals'] = array();
        }
        ...
        <div class="wrap">
            ...
            <form method="post" action="options.php">
                ...
                <div id="general" class="tab-content">
                    ...
                    <table class="form-table">
                        <tr>
                            ...
                            <td>
                                <input type="checkbox" name="cc_chatbot_settings[enable_chatbot]" value="1" <?php checked('1', get_option('cc_chatbot_settings')['enable_chatbot'] ?? '1'); ?> />
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="cc_chatbot_settings[organization_name]" value="<?php echo esc_attr(get_option('cc_chatbot_settings')['organization_name'] ?? 'Save the Elephants'); ?>" class="regular-text" />
                        ...
                        <tr>
                            ...
                            <td>
                                <select name="cc_chatbot_settings[organization_type]">
                                    ...
                                    $current_type = get_option('cc_chatbot_settings')['organization_type'] ?? 'wildlife';
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="cc_chatbot_settings[api_key]" id="cc_api_key" value="<?php echo esc_attr(get_option('cc_chatbot_settings')['api_key'] ?? ''); ?>" class="regular-text" style="font-family: monospace;" />
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                $selected_animals = get_option('cc_chatbot_settings')['selected_animals'] ?? $default_animals;
                                ...
                                <!-- Hidden field to ensure the option gets updated even when no animals are selected -->
                                <input type="hidden" name="cc_chatbot_settings[selected_animals_processed]" value="1" />
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <select name="cc_chatbot_settings[show_on_pages][]" multiple>
                                    <option value="all" <?php selected(in_array('all', get_option('cc_chatbot_settings')['show_on_pages'] ?? array('all'))); ?>>All Pages</option>
                                                                    <?php
                                // Limit pages to prevent memory issues
                                $pages = get_pages(array('numberposts' => 50));
                                $selected_pages = get_option('cc_chatbot_settings')['show_on_pages'] ?? array('all');
                ...
                <div id="appearance" class="tab-content" style="display: none;">
                    ...
                    <table class="form-table">
                        <tr>
                            ...
                            <td>
                                <select name="cc_chatbot_settings[position]">
                                    ...
                                    $current_position = get_option('cc_chatbot_settings')['position'] ?? 'bottom-right';
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="cc_chatbot_settings[color_primary]" value="<?php echo esc_attr(get_option('cc_chatbot_settings')['color_primary'] ?? '#222'); ?>" class="color-picker" />
                            </td>
                        </tr>
                        <tr>
                            <th scope="row">Secondary Color</th>
                            <td>
                                <input type="text" name="cc_chatbot_settings[color_secondary]" value="<?php echo esc_attr(get_option('cc_chatbot_settings')['color_secondary'] ?? '#444'); ?>" class="color-picker" />
                            </td>
                        </tr>
                        <tr>
                            <th scope="row">Accent Color</th>
                            <td>
                                <input type="text" name="cc_chatbot_settings[color_accent]" value="<?php echo esc_attr(get_option('cc_chatbot_settings')['color_accent'] ?? '#222'); ?>" class="color-picker" />
                            </td>
                        </tr>
                        <tr>
                            <th scope="row">Background Color</th>
                            <td>
                                <input type="text" name="cc_chatbot_settings[color_background]" value="<?php echo esc_attr(get_option('cc_chatbot_settings')['color_background'] ?? 'rgba(255, 255, 255, 0.2)'); ?>" class="color-picker" />
                            </td>
                        </tr>
                        <tr>
                            <th scope="row">Text Color</th>
                            <td>
                                <input type="text" name="cc_chatbot_settings[color_text]" value="<?php echo esc_attr(get_option('cc_chatbot_settings')['color_text'] ?? '#333333'); ?>" class="color-picker" />
                            </td>
                        </tr>
                        <tr>
                            <th scope="row">Light Text Color</th>
                            <td>
                                <input type="text" name="cc_chatbot_settings[color_text_light]" value="<?php echo esc_attr(get_option('cc_chatbot_settings')['color_text_light'] ?? '#ffffff'); ?>" class="color-picker" />
                            </td>
                        </tr>
                    </table>
                </div>
                ...
                <div id="typography" class="tab-content" style="display: none;">
                    ...
                    <table class="form-table">
                        <tr>
                            ...
                            <td>
                                <select name="cc_chatbot_settings[font_family]">
                                    ...
                                    $current_font = get_option('cc_chatbot_settings')['font_family'] ?? 'Arial, sans-serif';
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="cc_chatbot_settings[font_size_small]" value="<?php echo esc_attr(get_option('cc_chatbot_settings')['font_size_small'] ?? '12px'); ?>" class="small-text" />
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="cc_chatbot_settings[font_size_medium]" value="<?php echo esc_attr(get_option('cc_chatbot_settings')['font_size_medium'] ?? '14px'); ?>" class="small-text" />
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="cc_chatbot_settings[font_size_large]" value="<?php echo esc_attr(get_option('cc_chatbot_settings')['font_size_large'] ?? '16px'); ?>" class="small-text" />
                ...
                <div id="sizes" class="tab-content" style="display: none;">
                    ...
                    <table class="form-table">
                        <tr>
                            ...
                            <td>
                                <input type="number" name="cc_chatbot_settings[chat_window_width]" value="<?php echo esc_attr(get_option('cc_chatbot_settings')['chat_window_width'] ?? 320); ?>" class="small-text" min="200" max="600" />
                            </td>
                        </tr>
                        <tr>
                            <th scope="row">Chat Window Height (px)</th>
                            <td>
                                <input type="number" name="cc_chatbot_settings[chat_window_height]" value="<?php echo esc_attr(get_option('cc_chatbot_settings')['chat_window_height'] ?? 450); ?>" class="small-text" min="300" max="800" />
                            </td>
                        </tr>
                        <tr>
                            <th scope="row">Launcher Size (px)</th>
                            <td>
                                <input type="number" name="cc_chatbot_settings[launcher_size]" value="<?php echo esc_attr(get_option('cc_chatbot_settings')['launcher_size'] ?? 60); ?>" class="small-text" min="40" max="100" />
                            </td>
                        </tr>
                        <tr>
                            <th scope="row">Avatar Size (px)</th>
                            <td>
                                <input type="number" name="cc_chatbot_settings[avatar_size]" value="<?php echo esc_attr(get_option('cc_chatbot_settings')['avatar_size'] ?? 40); ?>" class="small-text" min="20" max="80" />
                            </td>
                        </tr>
                        <tr>
                            <th scope="row">Close Button Size (px)</th>
                            <td>
                                <input type="number" name="cc_chatbot_settings[close_button_size]" value="<?php echo esc_attr(get_option('cc_chatbot_settings')['close_button_size'] ?? 24); ?>" class="small-text" min="16" max="48" />
                            </td>
                        </tr>
                    </table>
                </div>
                ...
                <div id="borders" class="tab-content" style="display: none;">
                    ...
                    <table class="form-table">
                        <tr>
                            ...
                            <td>
                                <input type="number" name="cc_chatbot_settings[border_radius_chat_window]" value="<?php echo esc_attr(get_option('cc_chatbot_settings')['border_radius_chat_window'] ?? 12); ?>" class="small-text" min="0" max="50" />
                            </td>
                        </tr>
                        <tr>
                            <th scope="row">Chat Bubbles Border Radius (px)</th>
                            <td>
                                <input type="number" name="cc_chatbot_settings[border_radius_chat_bubbles]" value="<?php echo esc_attr(get_option('cc_chatbot_settings')['border_radius_chat_bubbles'] ?? 18); ?>" class="small-text" min="0" max="50" />
                            </td>
                        </tr>
                        <tr>
                            <th scope="row">Launcher Border Radius (px)</th>
                            <td>
                                <input type="number" name="cc_chatbot_settings[border_radius_launcher]" value="<?php echo esc_attr(get_option('cc_chatbot_settings')['border_radius_launcher'] ?? 50); ?>" class="small-text" min="0" max="50" />
                            </td>
                        </tr>
                        <tr>
                            <th scope="row">Input Field Border Radius (px)</th>
                            <td>
                                <input type="number" name="cc_chatbot_settings[border_radius_input_field]" value="<?php echo esc_attr(get_option('cc_chatbot_settings')['border_radius_input_field'] ?? 20); ?>" class="small-text" min="0" max="50" />
                            </td>
                        </tr>
                        <tr>
                            <th scope="row">Prompt Buttons Border Radius (px)</th>
                            <td>
                                <input type="number" name="cc_chatbot_settings[border_radius_prompt_buttons]" value="<?php echo esc_attr(get_option('cc_chatbot_settings')['border_radius_prompt_buttons'] ?? 15); ?>" class="small-text" min="0" max="50" />
                            </td>
                        </tr>
                    </table>
                </div>
                ...
                <div id="prompts" class="tab-content" style="display: none;">
                    ...
                    <table class="form-table">
                        <tr>
                            ...
                            <td>
                                <input type="checkbox" name="cc_chatbot_settings[enable_quick_prompts]" value="1" <?php checked('1', get_option('cc_chatbot_settings')['enable_quick_prompts'] ?? '1'); ?> />
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="cc_chatbot_settings[prompt_1_text]" value="<?php echo esc_attr(get_option('cc_chatbot_settings')['prompt_1_text'] ?? ''); ?>" class="regular-text" />
                            </td>
                        </tr>
                        <tr>
                            <th scope="row">Prompt 1 - Message</th>
                            <td>
                                <input type="text" name="cc_chatbot_settings[prompt_1_message]" value="<?php echo esc_attr(get_option('cc_chatbot_settings')['prompt_1_message'] ?? ''); ?>" class="regular-text" />
                            </td>
                        </tr>
                        <tr>
                            <th scope="row">Prompt 2 - Button Text</th>
                            <td>
                                <input type="text" name="cc_chatbot_settings[prompt_2_text]" value="<?php echo esc_attr(get_option('cc_chatbot_settings')['prompt_2_text'] ?? ''); ?>" class="regular-text" />
                            </td>
                        </tr>
                        <tr>
                            <th scope="row">Prompt 2 - Message</th>
                            <td>
                                <input type="text" name="cc_chatbot_settings[prompt_2_message]" value="<?php echo esc_attr(get_option('cc_chatbot_settings')['prompt_2_message'] ?? ''); ?>" class="regular-text" />
                            </td>
                        </tr>
                        <tr>
                            <th scope="row">Prompt 3 - Button Text</th>
                            <td>
                                <input type="text" name="cc_chatbot_settings[prompt_3_text]" value="<?php echo esc_attr(get_option('cc_chatbot_settings')['prompt_3_text'] ?? ''); ?>" class="regular-text" />
                            </td>
                        </tr>
                        <tr>
                            <th scope="row">Prompt 3 - Message</th>
                            <td>
                                <input type="text" name="cc_chatbot_settings[prompt_3_message]" value="<?php echo esc_attr(get_option('cc_chatbot_settings')['prompt_3_message'] ?? ''); ?>" class="regular-text" />
                            </td>
                        </tr>
                    </table>
                </div>
                ...
                <div id="features" class="tab-content" style="display: none;">
                    ...
                    <table class="form-table">
                        <tr>
                            ...
                            <td>
                                <input type="checkbox" name="cc_chatbot_settings[enable_heart]" value="1" <?php checked('1', get_option('cc_chatbot_settings')['enable_heart'] ?? '1'); ?> />
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="checkbox" name="cc_chatbot_settings[enable_animal_selector]" value="1" <?php checked('1', get_option('cc_chatbot_settings')['enable_animal_selector'] ?? '1'); ?> />
                        ...
                        <tr>
                            ...
                            <td>
                                <fieldset>
                                    ...
                                    $selected_animals = get_option('cc_chatbot_settings')['selected_animals'] ?? array('tiger', 'elephant', 'panda');
                ...
                <input type="hidden" name="cc_chatbot_settings[custom_animals]" value="<?php 
                    $custom_animals = get_option('cc_chatbot_settings')['custom_animals'] ?? array();
                ...
                <input type="hidden" name="cc_chatbot_settings[theme]" value="<?php echo esc_attr(get_option('cc_chatbot_settings')['theme'] ?? 'nature'); ?>" />
