        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.success) {
                    ...
                    console.error('Failed to save animal selection:', response);
                    alert('Failed to save animal selection. Please try again.');
                }
            },
            error: function() {
                console.error('AJAX error saving animal selection');
                alert('Error saving animal selection. Please try again.');
            }
        });
    });
    });
