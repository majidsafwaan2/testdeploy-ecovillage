...
class CC_Admin {
    ...
    public function init() {
        ...
        add_action('wp_ajax_cc_save_animal_selection', array($this, 'save_animal_selection'));
    }
    ...
    public function sanitize_settings($input) {
        ...
        // Animal settings - SIMPLE DIRECT APPROACH
        // Always process selected_animals based on what's in the input
