...
class CC_Admin {
    ...
    public function sanitize_settings($input) {
        ...
        error_log('CC Debug - Input received: ' . print_r($input, true));
        ...
        if (isset($input['animal_selection_processed'])) {
            ...
            error_log('CC Debug - Animal selection not processed, keeping existing animals: ' . print_r($sanitized['selected_animals'], true));
        }
