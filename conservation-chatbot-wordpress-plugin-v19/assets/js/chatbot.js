...
(function($) {
    ...
    function getAnimals() {
        ...
        const selectedAnimals = typeof cc_settings !== 'undefined' && cc_settings.selected_animals ? cc_settings.selected_animals : ['tiger', 'elephant', 'panda'];
        ...
        // Filter animals based on selected animals
        return allAnimals.filter(animal => selectedAnimals.includes(animal.id));
    }
