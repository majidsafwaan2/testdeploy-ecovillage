...
class ConservationChatbot {
    ...
    private function get_customization_settings() {
        return array(
            ...
            'colors' => array(
                'primary' => $this->get_option('color_primary', '#222'),
                'secondary' => $this->get_option('color_secondary', '#444'),
                'accent' => $this->get_option('color_accent', '#222'),
                'background' => $this->get_option('color_background', 'rgba(255, 255, 255, 0.2)'),
                'text' => $this->get_option('color_text', '#ffffff'),
