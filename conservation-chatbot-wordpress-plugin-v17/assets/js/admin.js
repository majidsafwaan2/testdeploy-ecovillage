...
jQuery(document).ready(function($) {
    ...
    // Function to collect custom animals data - simplified
    function collectCustomAnimalsData() {
        console.log('Collecting custom animals data...');
        // For now, just log that we're collecting data
    ...
    // Function to load existing custom animals - simplified to prevent memory issues
    function loadExistingCustomAnimals() {
        ...
        if (customAnimalsData && customAnimalsData !== '[]') {
            try {
                const customAnimals = JSON.parse(customAnimalsData);
                console.log('Loading existing custom animals:', customAnimals);
            } catch (error) {
    ...
    // Removed auto-save functionality to prevent memory issues
