...
class CC_Admin {
    ...
    public function admin_page() {
        ...
        <div class="wrap">
                                ...
                                foreach ($available_animals as $key => $label) : ?>
                                    <label style="display: block; margin-bottom: 5px;">
                                        <input type="checkbox" name="cc_selected_animals[]" value="<?php echo esc_attr($key); ?>" 
                                               <?php echo in_array($key, $selected_animals) ? 'checked="checked"' : ''; ?> />
                                        <?php echo esc_html($label); ?>
                                    </label>
                                <?php endforeach; ?>
                ...
                <div id="appearance" class="tab-content" style="display: none;">
                    ...
                    <table class="form-table">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="cc_color_primary" value="<?php echo esc_attr(get_option('cc_color_primary', '#2d5016')); ?>" class="color-picker" />
                            </td>
                        </tr>
                        <tr>
                            <th scope="row">Secondary Color</th>
                            <td>
                                <input type="text" name="cc_color_secondary" value="<?php echo esc_attr(get_option('cc_color_secondary', '#4a7c59')); ?>" class="color-picker" />
                            </td>
                        </tr>
                        <tr>
                            <th scope="row">Accent Color</th>
                            <td>
                                <input type="text" name="cc_color_accent" value="<?php echo esc_attr(get_option('cc_color_accent', '#8bc34a')); ?>" class="color-picker" />
                            </td>
                        </tr>
                        <tr>
            ...
            <p>Click the button below to reset all settings to their default values (exact original chatbot appearance).</p>
            ...
            <p class="description">This will reset all customization options to match the original chatbot design.</p>
        </div>
    ...
    public function reset_settings() {
        ...
        // Default settings - exact match to original chatbot
        $defaults = array(
            'cc_enable_chatbot' => '1',
            ...
            // Colors - exact match to original black theme
            'cc_color_primary' => '#222222',
            'cc_color_secondary' => '#444444',
            'cc_color_accent' => '#222222',
